...
/****************************************************************/
#ifndef ELASTICITYTENSORTOOLSPARAKEET_H
#define ELASTICITYTENSORTOOLSPARAKEET_H

class RankFourTensor;

namespace ElasticityTensorToolsParakeet
{
...
#endif //ELASTICITYTENSORTOOLSPARAKEET_H
